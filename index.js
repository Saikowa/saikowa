                 ...
                 var CryEmbed = new Discord.RichEmbed() 
                        ...
                        if(defineduser){  
                         ...
                         var PatEmbed = new Discord.RichEmbed() 
                                ...
                                var handholding = ["https://media.giphy.com/media/OHrqjpvWcwI2k/giphy.gif", "https://media.giphy.com/media/11DxcyjrKPAuVG/giphy.gif", "https://media.giphy.com/media/XTPC3KcmYAXde/giphy.gif", "https://media.giphy.com/media/w7RGPBLGO8rjq/giphy.gif", "https://media.giphy.com/media/XTPC3KcmYAXde/giphy.gif"]
                                                var handholding= handholding[Math.floor(Math.random() * handholding.length)] ;
                                            var text = message.content.substring(13) 
                                if(defineduser){  
                                 var HandholdingEmbed = new Discord.RichEmbed() 
                                           .setColor ('#00FAD9') 
                                           .setDescription(`${message.author.username} Tiens la main de ${defineduser.username}`)
                                            .setImage(handholding)
                                            .setTimestamp() 
                                           .setFooter(`Handholding`);
                                           message.channel.send(HandholdingEmbed);
                                           console.log(`${message.author.username} | Handholding`)
                                }else{
                                 var PatEmbed = new Discord.RichEmbed() 
                                           .setColor ('#00FAD9') 
                                           .setDescription(`${message.author.username} Tiens la main de  ${bot.user.username}`, false )
                                            .setImage(handholding)
                                            .setTimestamp() 
                                           .setFooter(`HandHolding`);
                                           message.channel.send(HandholdingEmbed);
